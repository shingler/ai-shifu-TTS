...
export const ADMIN_TABLE_HEADER_BASE_CLASS =
  '!h-[var(--height-h-10,40px)] !min-w-[85px] !whitespace-nowrap gap-[10px] !border-r-0 !border-b !border-[var(--base-border,#E5E5E5)] !bg-[var(--base-muted,#F5F5F5)] !px-[var(--spacing-2,8px)] !text-left !text-[length:var(--text-sm-font-size,14px)] not-italic !font-[var(--font-weight-medium,500)] !leading-[var(--text-sm-line-height,20px)] !text-[var(--base-foreground,#0A0A0A)]';

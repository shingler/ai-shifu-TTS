...
const DROPDOWN_MENU_CHECKABLE_ITEM_BASE_CLASS =
  'relative flex select-none items-center rounded-md py-2 ps-3 pe-9 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50';
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(DROPDOWN_MENU_ITEM_BASE_CLASS, inset && 'ps-8', className)}
    {...props}
  />
));
